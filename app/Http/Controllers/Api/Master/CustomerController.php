...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $listCustomer = $this->customer->getAll($filter, $request->itemperpage ?? 0, $request->sort ?? '');
    ...
    public function store(CustomerRequest $request)
    {
        ...
        $dataInput = $request->only(['nama', 'email', 'is_verified','phone_number','foto','date_of_birth']);
    ...
    public function update(CustomerRequest $request)
    {
        ...
        $dataInput = $request->only(['nama', 'email', 'is_verified', 'id','date_of_birth','foto','phone_number']);
